...
import 'package:pd/enterd.dart';
import 'package:pd/verifyaccount.dart';
              ...
              GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const EnteredScreen()));
                  },
                  child: Container(
                      ...
                      child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(right: 180, top: 25),
                              child: Text('Email',
                                  style: TextStyle(
                                      fontSize: 20,
              ...
              GestureDetector(
                  ...
                  child: Container(
                      ...
                      child: Row(
                          ...
                          children: [
                            Image.asset(
                              'assets/images/Rectangle 281.jpg',
                              height: 80,
                              width: 80,
                            ),
                            const SizedBox(
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(right: 130, top: 25),
                              child: Text('Password',
                                  style: TextStyle(
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold,
                            ...
                            Padding(
                              padding: const EdgeInsets.only(
                                  right: 1, top: 10, left: 3),
                              child: Image.asset(
                                'assets/images/Rectangle 282.png',
                                width: 50,
                                height: 50,
                              ),
                            )
                          ...
                          child: Container(
                            ...
                            decoration: const BoxDecoration(
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image:
                                      AssetImage('assets/Rectangle 281.png')),
                            ),
                          ),
                        ),
                        const SizedBox(
